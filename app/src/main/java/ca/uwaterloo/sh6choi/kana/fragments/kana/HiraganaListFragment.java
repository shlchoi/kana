 ...
 */
public class HiraganaListFragment extends Fragment implements KanaCharacterPresenter.CharacterView,
    ...
    private HiraganaCharacterPresenter mPresenter;
    ...
    public static HiraganaListFragment getInstance(Bundle args) {
        HiraganaListFragment fragment = new HiraganaListFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mPresenter = new HiraganaCharacterPresenter(getContext(), this);
        mPresenter.obtainRegularCharacters();
    }
    ...
    public void onResume() {
        ...
        successFilter.addAction(HiraganaWebIntentService.ACTION_SUCCESS);
    ...
    public void onRefresh() {
        Intent intent = new Intent(getContext(), HiraganaWebIntentService.class);
