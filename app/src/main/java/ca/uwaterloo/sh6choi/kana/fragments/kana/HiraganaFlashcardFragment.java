 ...
 */
public class HiraganaFlashcardFragment extends Fragment implements DrawerFragment, KanaCharacterPresenter.CharacterView {
    ...
    public static HiraganaFlashcardFragment getInstance(Bundle args) {
        HiraganaFlashcardFragment fragment = new HiraganaFlashcardFragment();
